...
public class TypeDemo {
    ...
    public static void test(TypeDemo p0,
                            List<TypeDemo> p1,
                            Map<String,TypeDemo> p2,
                            List<String>[] p3,
                            Map<String,TypeDemo>[] p4,
                            List<? extends TypeDemo> p5,
                            Map<? extends TypeDemo,? super TypeDemo> p6
                            //T p7
    ){
        System.out.println("==================");
    }
    ...
    public static void main(String[] args) {
        ...
        Method[] methods=TypeDemo.class.getMethods();
